...
export default function CreateOrderPage() {
  ...
  return (
    <AdminLayout
      ...
      pageSubtitle="Create a new order for customers"
    >
      {/* Back Button */}
        ...
        <CardWrapper>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <FormSelect
              ...
              onChange={(value) => setFormData(prev => ({ ...prev, orderType: value as any }))}
        ...
        <CardWrapper>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <FormSelect
              ...
              onChange={(value) => setFormData(prev => ({ ...prev, deviceInfo: { ...prev.deviceInfo, type: value as any } }))}
